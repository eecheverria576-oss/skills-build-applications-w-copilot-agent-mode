      ...
      <div className="card-body p-4">
        <div className="d-flex justify-content-between align-items-center mb-3">
          <div>
            ...
            <h2 className="h4 fw-bold mb-0">Recent activity log</h2>
          </div>
          <span className="badge bg-primary-subtle text-primary">{items.length} items</span>
        </div>
        ...
        {error ? (
          ...
          <div className="table-responsive">
            <table className="table table-hover align-middle">
              ...
              <tbody>
                {items.map((item) => (
                  <tr key={item._id || item.id || `${item.type}-${item.user}`}>
